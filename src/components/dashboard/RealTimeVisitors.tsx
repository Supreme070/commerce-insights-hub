...
const sources = [
  { name: "Direct", pct: 34, color: "bg-google-blue", barColor: "hsl(214,82%,51%)", icon: Globe },
  { name: "Search", pct: 28, color: "bg-google-green", barColor: "hsl(137,52%,43%)", icon: Search },
  { name: "Social", pct: 22, color: "bg-google-yellow", barColor: "hsl(43,97%,50%)", icon: Share2 },
  { name: "Email", pct: 16, color: "bg-text-muted", barColor: "hsl(210,5%,63%)", icon: Mail },
];

const stats = [
  { label: "Today", value: "1,847" },
  { label: "This Week", value: "12,340" },
    ...
    >
      ...
      <div className="flex items-end justify-between mb-4">
        <div className="flex items-baseline gap-2">
          <span className="font-google text-[40px] font-semibold text-foreground leading-none tracking-tight">142</span>
